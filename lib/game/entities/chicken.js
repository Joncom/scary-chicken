...
.defines(function() {
    ...
    EntityChicken = ig.Entity.extend({
        ...
        cluckSound: new ig.Sound('media/audio/chicken-cluck.mp3'),
        ...
        update: function() {
            ...
            if( this.behaviour > 0 ) {
                ...
                // TO BE REPLACED WITH FLY ANIMATION!
                else this.currentAnim = this.anims['idle'];

                // Set animation speed.
                if( this.vel.x !== 0 ) {

                    if( Math.abs( this.vel.x ) > 50 ) var frameTime = 0.1;

                    else var frameTime = 0.3;
