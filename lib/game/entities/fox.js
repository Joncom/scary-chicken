        ...
        check: function(other) {
            ...
            if( other.name === 'chicken' ) {
                ...
                if( this.eaten === ig.game.eggTotal ) {
                    ...
                    var clock = ig.game.getEntitiesByType(EntityClock)[0];

                    clock.timer.pause();

                    // High score?
                    if( ! ig.game.highscore ) ig.game.highscore = clock.timeString;

                    else {

                        // A high score already exists, overwrite?
                        if( ig.game.highscore < clock.timeString ) {

                            // New highscore!
                            ig.game.highscore = clock.timeString;
