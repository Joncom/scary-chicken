...
MyGame = ig.Game.extend({
	...
	sound: new ig.Sound( 'media/audio/song.mp3' ),

	sound1: new ig.Sound( 'media/audio/track1.mp3' ),
	sound2: new ig.Sound( 'media/audio/track2.mp3' ),
	sound3: new ig.Sound( 'media/audio/track3.mp3' ),
	sound4: new ig.Sound( 'media/audio/track4.mp3' ),
	sound5: new ig.Sound( 'media/audio/track5.mp3' ),
	sound6: new ig.Sound( 'media/audio/track6.mp3' ),
	...
	init: function() {
		...
		this.sound.currentClip.addEventListener( 'ended', this.test, false );
