...
MyGame = ig.Game.extend({
    ...
    init: function() {
        ...
        // Down key is not used for anything.
        ...
        if( ig.ua.mobile ) {
            ...
            this.buttons = [
                ...
                new ig.TouchButton( 'left', ig.system.width / 2, ig.system.height / 2, ig.system.width / 2, ig.system.height / 2 ),

                new ig.TouchButton( 'right', 0, ig.system.height / 2, ig.system.width / 2, ig.system.height / 2 )
        ...
        ig.music.add( 'media/audio/track1.mp3', 'track1' );

        ig.music.add( 'media/audio/track2.mp3', 'track2' );

        ig.music.add( 'media/audio/track3.mp3', 'track3' );

        ig.music.add( 'media/audio/track4.mp3', 'track4' );

        ig.music.add( 'media/audio/track5.mp3', 'track5' );

        ig.music.add( 'media/audio/track6.mp3', 'track6' );
